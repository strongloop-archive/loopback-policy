...
Thank you for your interest in `loopback-policy`, an open source project
administered by StrongLoop.

Contributing to `loopback-policy` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/loopback-policy)
